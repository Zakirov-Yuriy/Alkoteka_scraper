...
def get_random_proxy(self):
    if not self.working_proxies:
        self.logger.warning("Нет рабочих прокси, работаем без прокси")
        return None
...
PROXIES = [
    ...
    # "http://154.62.226.126:8888",
    # "http://104.238.30.16:63231",
    # "http://104.238.30.14:63233",
    # "http://63.141.249.242:8888",
    # "http://38.54.25.61:8080",
    # "http://213.233.178.137:3128",
    ...
    # "http://51.79.99.237:4502",
    # "http://104.238.30.12:63232",
    # "http://104.238.30.16:63231",
    # "http://104.238.30.14:63233",
    # "http://63.141.249.242:8888",
    # "http://38.54.25.61:8080",
    # "http://94.182.146.250:8080",
    # "http://45.166.93.113:999",
    # "http://213.233.178.137:3128",
    # "http://47.90.205.231:33333",
    # "http://200.174.198.86:8888",
    # "http://40.192.6.219:40814"
...
class AlkotekaSpider(scrapy.Spider):
    ...
    def parse_product(self, response):
        ...
        if not description:
            description = (product_data.get("subname") or "").strip()
